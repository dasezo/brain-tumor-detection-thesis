...
from models.classification import load_classification_model, classify_tumor
...
app.config['ALLOWED_EXTENSIONS'] = {'png', 'jpg', 'jpeg', 'tif', 'tiff', 'nii', 'nii.gz'}
...
def upload_file():
    ...
    if file and allowed_file(file.filename):
        ...
        try:
            ...
            original_img, segmented_img, tumor_mask, has_tumor = process_image_for_segmentation(
                filepath, segmentation_model
            )
            ...
            save_segmentation_result(original_img, segmented_img, tumor_mask, result_path, overlay_path)
            
            # Classify tumor (LGG or HGG)
            tumor_grade, confidence = classify_tumor(segmented_img, tumor_mask, classification_model)
